...
$replacements = [
    'narad1972\\\\TwitterClient\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    'Nir Arad'                 => function () use(&$values) { return $values['author_name']; },
    '@narad1972'             => function () use(&$values) { return $values['author_github_username']; },
    'https://www.linkedin.com/in/narad/'              => function () use(&$values) { return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']); },
    'narad1972@gmail.com'                => function () use(&$values) { return $values['author_email'] ?: ($values['author_github_username'] . '@example.com'); },
    'narad1972'                      => function () use(&$values) { return $values['package_vendor']; },
    'TwitterClient'                => function () use(&$values) { return $values['package_name']; },
    'A Twitter API Client in PHP'         => function () use(&$values) { return $values['package_description']; },
